...
public:
  FMIServer(string fmuPath, bool debugLogging, jm_log_level_enu_t logLevel, string hdf5Filename, int filter_depth)
   : Server(fmuPath, debugLogging, logLevel, hdf5Filename, filter_depth) {}
  ~FMIServer() {};
