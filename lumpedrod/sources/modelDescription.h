...
typedef struct {
    ...
    fmi2Real tau1; //VR=10
    fmi2Real tau2; //VR=11
    fmi2Real omega_drive1; //VR=12
    fmi2Real omega_drive2; //VR=13
    fmi2Real J0; //VR=14
    fmi2Real compliance; //VR=15
    fmi2Real D; //VR=16
    fmi2Real K_drive1; //VR=17
    fmi2Real D_drive1; //VR=18
    fmi2Real K_drive2; //VR=19
    fmi2Real D_drive2; //VR=20
    fmi2Real step; //VR=21
    fmi2Real theta01; //VR=22
    fmi2Real theta02; //VR=23
    fmi2Real omega01; //VR=24
    fmi2Real omega02; //VR=25
    fmi2Real driver_sign1; //VR=26
    fmi2Real driver_sign2; //VR=27
    fmi2Integer n_elements; //VR=0
...
#define VR_TAU1 10
#define VR_TAU2 11
#define VR_OMEGA_DRIVE1 12
#define VR_OMEGA_DRIVE2 13
#define VR_J0 14
#define VR_COMPLIANCE 15
#define VR_D 16
#define VR_K_DRIVE1 17
#define VR_D_DRIVE1 18
#define VR_K_DRIVE2 19
#define VR_D_DRIVE2 20
#define VR_STEP 21
#define VR_THETA01 22
#define VR_THETA02 23
#define VR_OMEGA01 24
#define VR_OMEGA02 25
#define VR_DRIVER_SIGN1 26
#define VR_DRIVER_SIGN2 27
#define VR_N_ELEMENTS 0
...
static fmi2Status generated_fmi2SetReal(modelDescription_t *md, const fmi2ValueReference vr[], size_t nvr, const fmi2Real value[]) {
    ...
    for (i = 0; i < nvr; i++) {
        ...
        case 12: md->omega_drive1 = value[i]; break;
        case 13: md->omega_drive2 = value[i]; break;
        case 14: md->J0 = value[i]; break;
        case 15: md->compliance = value[i]; break;
        case 16: md->D = value[i]; break;
        case 17: md->K_drive1 = value[i]; break;
        case 18: md->D_drive1 = value[i]; break;
        case 19: md->K_drive2 = value[i]; break;
        case 20: md->D_drive2 = value[i]; break;
        case 21: md->step = value[i]; break;
        case 22: md->theta01 = value[i]; break;
        case 23: md->theta02 = value[i]; break;
        case 24: md->omega01 = value[i]; break;
        case 25: md->omega02 = value[i]; break;
        case 26: md->driver_sign1 = value[i]; break;
        case 27: md->driver_sign2 = value[i]; break;
        default: return fmi2Error;
        }
    }
    return fmi2OK;
