...
typedef struct {
    ...
    fmi2Real step; //VR=23
    fmi2Real theta01; //VR=25
    fmi2Real theta02; //VR=26
    fmi2Real omega01; //VR=27
    fmi2Real omega02; //VR=28
    fmi2Real driver_sign1; //VR=29
    fmi2Real driver_sign2; //VR=30
    fmi2Real integrate_dt1; //VR=31
    fmi2Real integrate_dt2; //VR=32
    fmi2Integer n_elements; //VR=24
...
#define VR_STEP 23
#define VR_THETA01 25
#define VR_THETA02 26
#define VR_OMEGA01 27
#define VR_OMEGA02 28
#define VR_DRIVER_SIGN1 29
#define VR_DRIVER_SIGN2 30
#define VR_INTEGRATE_DT1 31
#define VR_INTEGRATE_DT2 32
#define VR_N_ELEMENTS 24
...
static fmi2Status generated_fmi2SetReal(modelDescription_t *md, const fmi2ValueReference vr[], size_t nvr, const fmi2Real value[]) {
    ...
    for (i = 0; i < nvr; i++) {
        ...
        case 23: md->step = value[i]; break;
        case 25: md->theta01 = value[i]; break;
        case 26: md->theta02 = value[i]; break;
        case 27: md->omega01 = value[i]; break;
        case 28: md->omega02 = value[i]; break;
        case 29: md->driver_sign1 = value[i]; break;
        case 30: md->driver_sign2 = value[i]; break;
        case 31: md->integrate_dt1 = value[i]; break;
        case 32: md->integrate_dt2 = value[i]; break;
        default: return fmi2Error;
        }
    }
    return fmi2OK;
